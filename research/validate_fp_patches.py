...
patch03 = read(PATCH_DIR / "03-timezone-geolocation-language.patch")

require(patch03, "content::PermissionResult(", "patch03")
require(patch03, "blink::mojom::PermissionStatus::DENIED", "patch03")
require(patch03, "blink::mojom::PermissionStatus::GRANTED", "patch03")
forbid(patch03, "Run(CONTENT_SETTING_BLOCK)", "patch03")
forbid(patch03, "Run(CONTENT_SETTING_ALLOW)", "patch03")
require(patch05, "RawByteSpan()", "patch05")
require(patch05, "NotShared<DOMFloat32Array>", "patch05")
require(patch05, "safe_size", "patch05")
require(patch05, "static_cast<size_t>(noise_size.ValueOrDie())", "patch05")
require(patch05, "static_cast<size_t>(buffer_size.ValueOrDie())", "patch05")
